        ...
        onslide: function($slide, index) {
            if(index==0){
                ...
                $(".ios a").hover(function(){
                    $(this).find("#img2").animate({opacity:"1"},300);
                },function(){
                    $(this).find("#img2").animate({opacity:"0"},300);
                })
            }else {
            ...
            if(index==2){
                var t3=setTimeout(function(){
                    $(".phone3").animate({top:"20%",right:"14%"},1600,"easeOutCubic")
                    $(".phonen3").animate({top:"26.5%",left:"21%"},1600,"easeOutCubic",function(){
                        $(".phonen3 img").animate({opacity:"1"});
                        $(".card1").animate({opacity:"1"},1000,"easeOutCubic",function(){
                            $(".card2").animate({opacity:"1"},1000,"easeOutCubic",function(){
                                $(".card3").animate({opacity:"1"},1000,"easeOutCubic",function(){
            ...
            if(index==3){
                var t4=setTimeout(function(){
                    ...
                    $(".phonen4").animate({top:"26%",right:"16%"},1600,"easeOutCubic",function(){
                        $(".phonen4 img").animate({opacity:"1"},1600);
            ...
            if(index==4){
                var t5=setTimeout(function(){
                    ...
                    $(".phonen5").animate({top:"26.5%",left:"21%"},1600,"easeOutCubic",function(){
                        ...
                        $(".card5-1").animate({opacity:"1"},1000,"easeOutCubic",function(){
                            $(".card5-2").animate({opacity:"1"},1000,"easeOutCubic",function(){
                                $(".card5-3").animate({opacity:"1"},1000,"easeOutCubic",function(){
                ...
                $(".card5-1").css("opacity","0");
                $(".card5-2").css("opacity","0");
                $(".card5-3").css("opacity","0");
            ...
            if(index==5){
                var t2=setTimeout(function(){
                    ...
                    $(".phonen6").animate({top:"26%",right:"16%"},1600,"easeOutCubic",function(){
                        $(".phonen6 img").animate({opacity:"1"},1600);
