$(function() {
                                ...
                                success:function(e){
                                    ...
                                    for(var i in data){
                                        if(i<3){
                                            ...
                                            //var love=data[i]['love'];
                                            mainData+="<div class='comment clearfix'><div class='comment-img'> <img src="+(profile?profile:'img/touxiangNews.png')+"> </div>";
                                            mainData+='<div class="comment-info"><div class="user-info clearfix">';
                                            mainData+='<div class="floatL"><div class="user-name">'+nickname+'</div></div>';
                                            mainData+='<div class="floatR">' +creatTime+'</div></div>';
                                            mainData+='<div class="comment-text">'+content+'</div></div></div>';
                                        }
    ...
    if(isAndroid){if(qq){$("#download").attr("href","https://qidianapkstatic.oss-cn-beijing.aliyuncs.com/qidianzixun_v3_3_20160804.apk");$("#footertu").attr("href","https://qidianapkstatic.oss-cn-beijing.aliyuncs.com/qidianzixun_v3_3_20160804.apk")}else{$("#download").attr("href","https://qidianapkstatic.oss-cn-beijing.aliyuncs.com/qidianzixun_v3_3_20160804.apk");$("#footertu").attr("href","https://qidianapkstatic.oss-cn-beijing.aliyuncs.com/qidianzixun_v3_3_20160804.apk")};}else if(isiOS||webApp){$("#download").attr("href","https://itunes.apple.com/cn/app/tou-tiao-bai-jia/id987333155?mt=8");$("#footertu").attr("href","https://itunes.apple.com/cn/app/tou-tiao-bai-jia/id987333155?mt=8");}else{$("#download").attr("href","http://deeporiginalx.com/");$("#footertu").attr("href","http://deeporiginalx.com/");}
